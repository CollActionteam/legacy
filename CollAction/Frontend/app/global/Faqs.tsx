    ...
    <Faq
        ...
        content={
            <span>
                ...
                <ol>
                    <li>The ProjectStarter launches a project on collaction.org. He/she proposes a certain action (for example switching to renewable energy), a target (minimum number of participants), and a deadline.</li>
        ...
        content={
            <span>
                <p>
                    ...
                    More information on how crowdacting resembles and differs from other initiatives can be found on <a href="http://www.crowdacting.org/" target="_blank">www.crowdacting.org</a>.
                </p>
            </span>
        } />,
...
renderComponentIf(
    <Faq
        ...
        content={
            <span>
                <p>
                    Collective action problems are situations where it is in the interest of the group to work together, but in which coordination is a challenge. Because of this, every individual has an incentive to act in their own interest. This <a href="https://www.youtube.com/watch?v=p3KlgxYhDbk" target="_blank">video</a> explains it clearly.
                </p>
                <p>
                ...
                <p>
                    ...
                    <ol>
                        <li>Privatisation: the commons can be divided between the farmers. Now the farmers benefit from taking good care of their own piece of land, so that it is of use to them in the long term.</li>
                        <li>Regulation: Agreements can be made and enforced about the usage of the commons. It is, for example, possible to decide on a maximum number of cows per farmer.</li>
                    </ol>
...
renderComponentIf(
    <Faq
        ...
        content={
            <span>
                Yes! You can create a project <a href="/Projects/StartInfo" target="_blank">here</a>. Make sure to check if your idea meets the CollAction criteria below.
            </span>
        } />,
        ...
        content={
            <span>
                <p>
                    ...
                    The document is in Dutch for now, since we are headquartered in the Netherlands and need to submit it to local authorities - but we're working on a translation - apologies!
